...
- `VK_PHYSICAL_DEVICE_TYPE` - Gpu type. (see [Vulkan.PhysicalDeviceType](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/PhysicalDeviceType.cs))
...
- stage {[Vulkan.ShaderStage](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/ShaderStage.cs)} [entryPoint]
- cull {[Vulkan.CullMode](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/CullMode.cs)}
- frontface {[Vulkan.FrontFace](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/FrontFace.cs)}
- blend {*disabled*|*off*}|{{[Vulkan.BlendFactor](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/BlendFactor.cs)} [[Vulkan.BlendOp](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/BlendOp.cs)] {[Vulkan.BlendFactor](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/BlendFactor.cs)}}
### Compiler Specific Options:
- language {*glsl*|*hlsl*}
- {[Vulkan.ShaderCompiler.Limit](https://github.com/bozidarsk/Vulkan-cs/tree/main/Vulkan/ShaderCompiler/Limit.cs)} {value}
